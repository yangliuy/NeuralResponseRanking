...
def main(argv):
    ...
    # parser.add_argument('--dropout_rate', help='Dropout_rate: dropout rate of the neural matching model.')
    # parser.add_argument('--kernel_count', help='Kernel count: number of kernals in the neural matching model.')
    ...
    # for baselines, try to run with mklov_200d and glove_300d_840b
    if embed_size != None:
