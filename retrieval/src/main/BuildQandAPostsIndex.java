 ...
 *    ! Note that the filtering null title step will filter all the answer posts! So QandAPostsIndex
 *     and QpostsIndex are both QpostsIndex
 ...
 * 4. [This class]As another option, for DMN-PRF, we can index all Q&A posts and retrieve the top K Q&A posts by candidate answer responses
...
public class BuildQandAPostsIndex {
        ...
        reader.setDefaultHandler(new ElementHandler() {
             public void onEnd(ElementPath ep) {
                  ...
                  if(id == null || id.equals("") ||
                	 ...
                	 title == null || title.equals("") || // !Filtering null title step will filter all the answer posts! So QandAPostsIndex and QpostsIndex are both QpostsIndex
...
//                  curD.add(new TextField("Tags", e.attributeValue("Tags"), Field.Store.YES));
        ...
        //w.flush();
		w.close();
		System.out.println("build questions and answers posts index done!");
	}
}
