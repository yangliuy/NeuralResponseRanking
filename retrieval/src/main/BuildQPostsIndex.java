 ...
 * 3. [This class]Only index question posts (include both question title and question bodyText) in Stack-Overflow. In this way,
...
//                  curD.add(new TextField("Tags", e.attributeValue("Tags"), Field.Store.YES));
        ...
        //w.flush();
		w.close();
		System.out.println("build question posts index done!");
	}
}
